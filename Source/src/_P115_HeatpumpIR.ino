 ...
 *
 * Send commands through http, like this example (assuming the IP address of the ESP node is 192.168.0.20):
 * * curl http://192.168.0.20/control?cmd=heatpumpir,panasonic_ckp,1,1,0,22,0,0
 *
...
HeatpumpIR *heatpumpIR[] = {new PanasonicCKPHeatpumpIR(), new PanasonicDKEHeatpumpIR(), new PanasonicJKEHeatpumpIR(),
                            ...
                            new HitachiHeatpumpIR(),new FuegoHeatpumpIR(),
                            NULL};
